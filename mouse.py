        ...
        for hand in hands:
            ...
            for id, landmark in enumerate(landmarks):   # add counter
                ...
                if id == 8:
                    ...
                    pyautogui.moveTo(clocx, clocy,0)
                ...
                if id==12:
                    ...
                    # print('distance : ', abs(index_x - middle_x))
                ...
                if id==0:
                    ...
                    # print('distance : ', abs(wrist_y - middle_y))
                    if abs(wrist_y-middle_y)<100:
                        # pyautogui.hotkey('ctrl','c')
                        exit()
                if id==2:
                    cv2.circle(img=frame, center=(x,y), radius=15, color=(255,0, 255))
                    thumbdown_x = (screen_width/frame_width)*x
                    thumbdown_y = (screen_height/frame_height)*y
                    print('distance : ', abs(thumbdown_y - index_y))
                    if abs(thumbdown_y-index_y)<60:
                        print("Scroll down")
                        pyautogui.scroll(-40)
